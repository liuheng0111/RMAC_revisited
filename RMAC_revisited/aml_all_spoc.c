...

{
  ...
  ebox eb1 = max_score(iim, pDims, p, a, qratio, qratiot, step, &c);
  c1 = c;
  eb =  box_refine(iim, pDims, p, a, eb1, rf_steps, rf_iter, &c);
  

  plhs[0] = mxCreateNumericMatrix (1, 12, mxSINGLE_CLASS, mxREAL);
  ...
  ret[6] = (float)eb1.s; ret[7] = (float)eb1.b.i1; ret[8] = (float)eb1.b.i2; ret[9] = (float)eb1.b.j1; ret[10] = (float)eb1.b.j2; ret[11] = (float)c1;
